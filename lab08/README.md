...
## What it does
The `im_so_sorry.py` program demonstrates both recursive and iterative approaches:

1. `blocks(n)` - A recursive function that calculates the sum of numbers from 1 to n (triangular numbers)
